...
const searchEngines = {
  google: (uri: any) => `https://www.google.com/search?q=${uri}`,
  duckduckgo: (uri: any) => `https://duckduckgo.com/?q=${uri}`,
  bing: (uri: any) => `https://www.bing.com/search?q=${uri}`,
};
...
class Browser extends Component {
  ...
  onBrowserError = (syntheticEvent: {nativeEvent: any}) => {
  ...
  onBrowserLoad = (syntheticEvent: {
    nativeEvent: {canGoForward: any; canGoBack: any; title: any};
  }) => {
  ...
  onBrowserMessage = (event: {nativeEvent: {data: any}}) => {
